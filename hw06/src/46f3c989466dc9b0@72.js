...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist.csv", {url: new URL("./aritst.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["public.csv", {url: new URL("./public.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
